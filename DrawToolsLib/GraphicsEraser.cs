...
{
    class GraphicsEraser : GraphicsRectangleBase
    {
        #region Constructors

        public GraphicsEraser(double left, double top, double right, double bottom,
        ...
        {
            return new PropertiesGraphicsEraser(this);
        }
